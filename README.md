In this project i will use the data "Toy Store E-Commerce Database" from maven analytics to analyse real business data. You can find the data [here](https://mavenanalytics.io/data-playground/toy-store-e-commerce-database).
